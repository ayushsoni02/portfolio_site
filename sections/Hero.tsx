        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              Full-stack developer focused on Solana, smart contracts, and privacy-first applications. 
              Experienced in confidential compute, DePIN, and indexing tools. Granted by Solana Foundation 
              x CoinDCX and active in Superteam collaborations, freelance projects, and hackathons.
            </p>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M2 5a2 2 0 012-2h8a2 2 0 012 2v10a2 2 0 002 2H4a2 2 0 01-2-2V5zm3.293 1.293a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 01-1.414-1.414L7.586 10 5.293 7.707a1 1 0 010-1.414zM11 12a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" />
                </svg>
              </a>
            </div>
          </div>
